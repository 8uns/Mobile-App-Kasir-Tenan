...
class InventarisMasuk extends StatefulWidget {
  static const nameRoute = '/InventarisMasuk';
  String dateTrans;

  InventarisMasuk(this.dateTrans);
  @override
  State<InventarisMasuk> createState() => _InventarisMasukState(dateTrans);
}

class _InventarisMasukState extends State<InventarisMasuk> {
  _InventarisMasukState(this.dateTrans);
  String dateTrans;
            ...
            onPressed: () async {
              ...
              if (pickedDate != null) {
                ...
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (context) => Inventaris(formattedDate, 0),
                  ),
                );
              } else {
